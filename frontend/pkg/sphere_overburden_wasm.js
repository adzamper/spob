 ...
 */
export function calculate_em_response(params_json) {
    const ptr0 = passStringToWasm0(params_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.calculate_em_response(ptr0, len0);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return ResponseData.__wrap(ret[0]);
}
...
export class ResponseData {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ResponseData.prototype);
        obj.__wbg_ptr = ptr;
        ResponseDataFinalization.register(obj, obj.__wbg_ptr, obj);
        return obj;
    }
    ...
    toJSON() {
        ...
        let deferred2_1;
        try {
            const ret = wasm.responsedata_toJSON(this.__wbg_ptr);
            var ptr1 = ret[0];
            var len1 = ret[1];
            if (ret[3]) {
                ptr1 = 0; len1 = 0;
...
if (Symbol.dispose) ResponseData.prototype[Symbol.dispose] = ResponseData.prototype.free;
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('sphere_overburden_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
